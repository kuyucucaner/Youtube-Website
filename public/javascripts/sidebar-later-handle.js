function toggleSidebar() {
    ...
    var historyContainer = document.getElementById("watch-later-container");
    ...
    thirdLine.forEach(function(element) {
        ...
        historyContainer.style.marginLeft = "6em"; // Sidebar genişliğine uygun olarak margin ayarla
        ...
        historyContainer.style.marginRight = "2.9em"; // Sidebar genişliğine uygun olarak margin ayarla
    }
}
