function toggleSidebar() {
    ...
    var youContainer = document.getElementById("you-container");
    ...
    if (sidebar.style.width === "16%") {
        ...
        youContainer.style.marginLeft = "6em"; // Sidebar genişliğine uygun olarak margin ayarla
        youContainer.style.marginRight = "3em"; // Sidebar genişliğine uygun olarak margin ayarla
    } else {
        ...
        youContainer.style.marginLeft = "16em"; // Sidebar genişliğine uygun olarak margin ayarla
        youContainer.style.marginRight = "1.5em"; // Sidebar genişliğine uygun olarak margin ayarla
    }
}
